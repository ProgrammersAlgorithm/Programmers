...
## 진행 방식
매주 최소 2문제씩 문제를 푸는 것을 목표로 합니다.<br>
...
발표자는 자신의 풀이 과정(+시간 복잡도 등)에 관하여 설명합니다.<br>

## 문제 선정
해당 주차 담당자가 최소 5문제를 선정하여 이슈에 올립니다.<br>
순서: 히데짱 → 박현제 → 박건우<br>
3문제 이상 고르는 경우에는, 필수/선택으로 문제를 구분해주세요.<br><br>
...
파일 이름은 다음과 같이 작성해주세요.<br>

### 예
프로그래머스) 문제이름 ex) 타겟_넘버.java<br>
PR 제목은 [해당 주차] 문제 이름 - 작성자 로 작성해주세요.<br>
ex) [1주차] 타겟 넘버 - 현제<br><br>


## 커밋 메시지 컨벤션
[상태] 문제이름 - 풀이한 사람 이름
[Success] : 풀이 성공
[Failed] : 풀이 실패 (코드 작성한 것은 올리기)
